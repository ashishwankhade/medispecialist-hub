...
const registerSchemaForAdmin = Joi.object({
  ...
  adminLocation: Joi.string().required(),

  adminMobileNo: Joi.string().required(),

  adminWhatsappNo: Joi.string().required(),
});
...
const appointmentSchema = Joi.object({
  doctorObjectId: Joi.string().required(),
  ...
  patientName: Joi.string().max(30).required(),
  ...
  patientLocation: Joi.string().required(),
...
const diagnosisSchema = Joi.object({
  ...
  residence: Joi.string().allow(null, ""),

  family: Joi.string().allow(null, ""),

  membersInFamily: Joi.number().allow(null, ""),

  identificationMarks: Joi.string().allow(null, ""),

  reliability: Joi.string().allow(null, ""),

  previousConsultation: Joi.string().allow(null, ""),

  consultationDetails: Joi.string().allow(null, ""),

  birthDevelopment: Joi.string().allow(null, ""),

  childhoodDisorders: Joi.string().allow(null, ""),

  homeAtmosphere: Joi.string().allow(null, ""),

  scholasticActivities: Joi.string().allow(null, ""),

  vocationHistory: Joi.string().allow(null, ""),

  menstrualHistory: Joi.string().allow(null, ""),

  sexualMaritalHistory: Joi.string().allow(null, ""),

  forensicHistory: Joi.string().allow(null, ""),

  generalPatternLiving: Joi.string().allow(null, ""),

  premorbidPersonality: Joi.string().allow(null, ""),

  relations: Joi.string().allow(null, ""),

  workLeisure: Joi.string().allow(null, ""),

  mood: Joi.string().allow(null, ""),

  character: Joi.string().allow(null, ""),

  attitudesStandards: Joi.string().allow(null, ""),

  habits: Joi.string().allow(null, ""),

  generalAppearance: Joi.string().allow(null, ""),

  attitude: Joi.string().allow(null, ""),

  motorBehavior: Joi.string().allow(null, ""),

  speech: Joi.string().allow(null, ""),

  cognitiveFunctions: Joi.string().allow(null, ""),

  moodAffect: Joi.string().allow(null, ""),

  thought: Joi.string().allow(null, ""),

  perceptualDisorders: Joi.string().allow(null, ""),

  judgment: Joi.string().allow(null, ""),

  insight: Joi.string().allow(null, ""),

  diagnosticFormulation: Joi.string().allow(null, ""),
...
const rescheduleAppointmentSchema = Joi.object({
  appointmentId: Joi.string().required(),
  newAppointmentDate: Joi.string().required(),
  newAppointmentTime: Joi.string().required(),

  isOnlineOrOffline: Joi.string().required(),
});

const switchDoctorAppointmentSchema = Joi.object({
  appointmentId: Joi.string().required(),
  selectedDoctorId: Joi.string().required(),
  newAppointmentDate: Joi.string().required(),
  newAppointmentTime: Joi.string().required(),
  reasonForSwitchDoctor: Joi.string().required(),
  isOnlineOrOffline: Joi.string().required(),
});
