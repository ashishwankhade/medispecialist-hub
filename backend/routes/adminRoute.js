...
import  { registerAdmin,loginAdmin, logoutAdmin ,addDoctorByAdmin, getAllDoctors,sendVerificationCode,uploadAllDoctorByAdmin, verifyVerificationCode,changePassword, sendForgotPasswordCode,verifyForgotPasswordCode, getSingleDoctor, getAllAppointments,  updateDoctorProfileByAdmin,getAllDiagnosesByAppointmentId,} from '../controllers/adminController.js';
...
adminRouter.put("/profile-update",upload.single('doctorImage'), updateDoctorProfileByAdmin);
